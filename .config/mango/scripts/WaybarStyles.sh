...
# Define directories
waybar_styles="$HOME/.config/mango/waybar/styles"
waybar_style="$HOME/.config/mango/waybar/style.css"
SCRIPTSDIR="$HOME/.config/mango/scripts"
rofi_config="$HOME/.config/mango/rofi/themes/config-waybar-style.rasi"
